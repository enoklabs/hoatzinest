...
--
-- Host: localhost
-- Generation Time: Jan 23, 2014 at 05:06 PM
...
--
-- Table structure for table `hoatzin_users`
--
...
--
-- Dumping data for table `hoatzin_users`
--

INSERT INTO `hoatzin_users` (`id`, `first_name`, `last_name`, `date_created`, `password`, `email_address`) VALUES
...
INSERT INTO `old_users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `forgotten_password_time`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES
...
INSERT INTO `projects` (`project_id`, `project_title`, `project_what`, `project_how`, `project_why`, `project_repo`, `project_goals`, `developers`, `engineers`, `managers`, `designers`, `artists`, `directors`, `marketers`, `animators`, `writers`, `image`) VALUES
...
INSERT INTO `team_members` (`id`, `project_id`, `user_id`) VALUES
(1, 10, 1),
(2, 10, 7),
(4, 11, 9),
(5, 10, 1),
...
INSERT INTO `users` (`id`, `email`, `password`, `first_name`, `last_name`, `location`) VALUES
(1, 'bpenkala84@gmail.com', 'b9ed55b90e649732efcc2cbca66bd225', 'Bryan', 'Penkala', 'Salem, IN'),
(9, 'enokslaboratory@fullsail.edu', '0da1a60df6ca3fcc8bd2a4079e7bfd23', 'Enok', 'Madrid', 'Las Vegas, NV');
...
ALTER TABLE `users_groups`
  ...
  ADD CONSTRAINT `fk_users_groups_users1` FOREIGN KEY (`user_id`) REFERENCES `old_users` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
